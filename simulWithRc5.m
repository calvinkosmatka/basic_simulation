function [disTree,indexx] = simulWithRc5(div1,div2,numGene,recomRate,simulTime)
...
indexBranchTwo = (randomUni2 < 0 & (randomUni2+shorter) >= 0);
indexBranchThree = (randomUni3 < 0 & (randomUni3+longer-shorter) >= 0);
indexBranchFour = ((randomUni4+longer) >= 0);
...
%indexTry1 = and(type1,indexBranchFourTry1);
%indexTry2 = and(type2,indexBranchFourTry1);
%indexTry3 = and(type1,indexBranchThreeTry1);
%indexTry4 = and(type3,indexBranchTwoTry1);
%indexTry5 = and(type4,indexBranchTwoTry1);
%randomUniformInitialPointOfRecom(indexTry1)= div1;
%randomUniformInitialPointOfRecom(indexTry2)= div1;
%randomUniformInitialPointOfRecom(indexTry3)= div1;
%randomUniformInitialPointOfRecom(indexTry4)= div1;
%randomUniformInitialPointOfRecom(indexTry5)= div1;
...
treeThatNotStop(indexShorter1,1) = shorter(indexShorter1);
treeThatNotStop(indexShorter1,2) = longer(indexShorter1);
treeThatNotStop(indexShorter1,3) = longer(indexShorter1);

treeThatNotStop(indexShorter2,2) = shorter(indexShorter2);
treeThatNotStop(indexShorter2,1) = longer(indexShorter2);
treeThatNotStop(indexShorter2,3) = longer(indexShorter2);

treeThatNotStop(indexShorter3,3) = shorter(indexShorter3);
treeThatNotStop(indexShorter3,1) = longer(indexShorter3);
treeThatNotStop(indexShorter3,2) = longer(indexShorter3);
...
totalLengthOfTheInitial(indexDone) = [];
